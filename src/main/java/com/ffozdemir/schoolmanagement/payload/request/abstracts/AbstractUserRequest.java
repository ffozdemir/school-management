package com.ffozdemir.schoolmanagement.payload.request.abstracts;
...
public abstract class AbstractUserRequest {
	...
	@NotNull
	@Pattern(regexp = "^(?!000|666)[0-8][0-9]{2}-(?!00)[0-9]{2}-(?!0000)[0-9]{4}$", message = "Please enter valid SSN number")
	private String ssn;
